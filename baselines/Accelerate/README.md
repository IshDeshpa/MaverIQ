...
2. **Scripts:**
The Accelerate scripts used for the E2E evaluation are the following:
...
- `accelerate_trace_replay.py`: This script generates the scaled Azure trace and runs the E2E experiment
   ...
   ```
- `accelerate_eval.sh`: Bash script that contains the commands executed for the artifacts in the paper
